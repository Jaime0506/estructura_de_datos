...
//					tree.deleteNodeByValue(value);
					try {
						Integer.parseInt(value); 
						JOptionPane.showMessageDialog(contentPane, "El valor ingresado es numerico, por favor indique unicamente Texto");
					...
					// TODO: handle exception
					JOptionPane.showMessageDialog(contentPane, "El valor ingresado no es numerico", "Error",
